...
for (let i = 0; i < inventory.length; i++) {
  ...
  let carYear = car.car_year;
  if (car === inventory[32]) {
    console.log(`Car 33 is a ${carMake} ${carModel} ${carYear}`);
  }
}
...
console.log(`Last car is ${make} ${model}`);
